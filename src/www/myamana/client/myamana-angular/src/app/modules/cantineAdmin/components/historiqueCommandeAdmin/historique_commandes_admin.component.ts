...
import { HistoriqueCommandesAdminResponse, HistoriqueCommandesAdminServices, HistoriqueCommandesAdmin } from './services/historique_commandes_admin.services';
...
@Component({
  ...
  templateUrl: `./historique_commandes_admin.component.html`,
  styles: []
})
export class HistoriqueCommandesAdminComponent implements OnInit {
  commandes: HistoriqueCommandesAdmin[] = [];
  // Full list fetched from server (subject to MAX limit)
  commandesAll: HistoriqueCommandesAdmin[] = [];
  isLoading = true;
  errorMessage = '';
  ...
  constructor(
    ...
    private historiqueCommandesServices: HistoriqueCommandesAdminServices
  ) { }
  ...
  fetchCommandes(): void {
    ...
    this.historiqueCommandesServices.getCommandesAdmin(params).subscribe({
      next: (response: HistoriqueCommandesAdminResponse & { total?: number }) => {
   ...
   * Annule une commande
   */
  annulerCommande(commande: HistoriqueCommandesAdmin): void {
  ...
  isLivraisonPassed(commande: HistoriqueCommandesAdmin): boolean {
